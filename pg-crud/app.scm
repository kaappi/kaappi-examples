...
(let ((args (command-line)))
  (cond
    ((and (>= (length args) 5) (equal? (list-ref args 1) "add"))
     (add-contact (list-ref args 2) (list-ref args 3) (list-ref args 4)))
    ((and (>= (length args) 2) (equal? (list-ref args 1) "list"))
     (list-contacts))
    ((and (>= (length args) 3) (equal? (list-ref args 1) "search"))
     (search-contacts (list-ref args 2)))
    ((and (>= (length args) 3) (equal? (list-ref args 1) "delete"))
     (delete-contact (list-ref args 2)))
    ((and (>= (length args) 2) (equal? (list-ref args 1) "stats"))
     (show-stats))
    ((and (>= (length args) 2) (equal? (list-ref args 1) "seed"))
     (seed-data))
    (else
